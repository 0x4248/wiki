root_folders = ['windows', 'linux', 'Hardware', 'radios', 'programming', 'other']
...
pages_file.write('<!--DO NOT EDIT THIS FILE-->\n')
pages_file.write('<!--Run: python tools/mkpages.py to regenerate this file-->\n')
